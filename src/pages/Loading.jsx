...
class Loading extends Component {
  render() {
    return (
      <div role="status" className="w-full h-full flex flex-row gap-2 justify-center">
        <h1 className="flex text-xl">Carregando...</h1>
        <svg
          aria-hidden="true"
          className="
            w-8
        ...
        >
          ...
          <path
            ...
            8.9121 86.7997 32.2913 88.1811 35.8758C89.083
